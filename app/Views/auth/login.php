                    ...
                    <div class="w3-container w3-content w3-padding-64">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-6 text-left bg-custom3 h-100">
                                <h4 class="w3-wide w3-center">Login</h4>
                                <form action="controller/auth.php?action=login" method="POST">
                                    <div class="mb-3">
                                        <label for="example-email" class="form-label text-white">
                                            <h4>Email</h4>
                                        </label>
                                    ...
                                    <br><br><br>
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-secondary w-100 bg-custom1 p-0">
                                            <h4>LOGIN</h4>
                                        </button>
                                    </div>
                            </div>
                            <div class="col-6 text-center">
                                <img src="/image/logo.jpg" alt="Blacklist International Logo">
                            </div>
                        </div>
                    </div>
                </main>
